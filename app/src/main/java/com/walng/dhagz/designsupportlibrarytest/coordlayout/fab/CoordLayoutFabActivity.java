package com.walng.dhagz.designsupportlibrarytest.coordlayout.fab;
...
public class CoordLayoutFabActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coord_layout_fab);
        initViews();
    }
